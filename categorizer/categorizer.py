...
class Categorizer:
    ...
    def _move(self, service_id, move_list):

        for ticket in move_list:
            result = self.i.ticket_move(ticket, service_id, '15550')
            if result is True:
                logging.info('Succesfully moved: %', ticket)
